          ...
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="white-text text-lighten-4">Ha Noi University Science and Technology</p>
                <p class="white-text text-lighten-4">Phone : 0388526678</p>
              </div>
